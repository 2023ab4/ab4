...
model_black_blue, states_black_blue = JLD2.load("../data/deep_black+blue.jld2", "model", "states");

# ╔═╡ 271399f5-9890-4541-9379-443c91751c57
model_blue_both, states_blue_both = JLD2.load("../data/deep_blue+both.jld2", "model", "states");

# ╔═╡ 1a43945a-b24c-4e71-b759-38d3239a7beb
model_blue, states_blue = JLD2.load("../data/deep_blue.jld2", "model", "states");

# ╔═╡ d22033df-eb5f-462d-b7ca-cbcf43dec49a
model_both, states_both = JLD2.load("../data/deep_both.jld2", "model", "states");
...
begin
	model_black_blue_swap, states_black_blue_swap = JLD2.load("../data/deep_black+blue.jld2", "model", "states");
...
begin
	model_blue_both_swap, states_blue_both_swap = JLD2.load("../data/deep_blue+both.jld2", "model", "states");
...
begin
	...
	model_blue_only_swap, states_blue_only_swap = JLD2.load("../data/deep_blue.jld2", "model", "states");
...
begin
	model_both_swap, states_both_swap = JLD2.load("../data/deep_both.jld2", "model", "states")
